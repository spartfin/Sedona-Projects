...
(function (window, document, undefined) {
  ...
  var regSize = /(\([^)]+\))?\s*(.+)/;
  var setOptions = window.picturefillCFG; // baseStyle also used by getEmValue (i.e.: width: 1em is important)
  ...
  function parseSrcset(input, set) {
    ...
    candidates = []; // (Declared outside of the while loop so that it's only created once.
